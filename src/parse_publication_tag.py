...
def parse_publication_tag(publication_data_file, output_keyword_file, query_string):
    keyword_dict = {}
    stem_keyword_dict = {}
...
def main():
    parse_publication_tag('../results/publication.data', '../results/publication.keywords', 'data mining')
