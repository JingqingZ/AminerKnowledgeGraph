...
../word2vec/word2vec -train $TRAIN_FILE -output $BIN_FILE -size 200 -window 5 -sample 1e-4 -negative 5 -hs 0 -binary 1 -cbow 1 -iter 3
../word2vec/word2vec -train $TRAIN_FILE -output $TXT_FILE -size 200 -window 5 -sample 1e-4 -negative 5 -hs 0 -binary 0 -cbow 1 -iter 3
