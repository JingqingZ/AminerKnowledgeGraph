...
./OpenCRF_Main -inf -niter 30 -nbipter 30 -srcmodel ./train_model.txt -method gradient -gradientstep 0.02 -hasvalue -trainfile ../results/$1/train.txt -testfile ../results/$1/train.txt
